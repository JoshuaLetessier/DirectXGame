...
public:
        ...
        mIsConstantBuffer(isConstantBuffer)
    {
        ...
        {
            HRESULT hr__ = (device->CreateCommittedResource(&CD3DX12_HEAP_PROPERTIES(D3D12_HEAP_TYPE_UPLOAD), D3D12_HEAP_FLAG_NONE, &CD3DX12_RESOURCE_DESC::Buffer(mElementByteSize * elementCount), D3D12_RESOURCE_STATE_GENERIC_READ, nullptr, __uuidof(**(&mUploadBuffer)), IID_PPV_ARGS_Helper(&mUploadBuffer))); std::wstring wfn = AnsiToWString("C:\\Users\\Faoll\\Downloads\\d3d12book-master\\d3d12book-master\\Common\\UploadBuffer.h"); 
            if ((((HRESULT)(hr__)) < 0)) {
