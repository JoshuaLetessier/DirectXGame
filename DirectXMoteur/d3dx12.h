...
//
//  Fichier :       d3dx12.h
//  Contenu :    bibliothèque d'utilitaires D3DX12
//
//////////////////////////////////////////////////////////////////////////////
...
struct CD3DX12_CLEAR_VALUE : public D3D12_CLEAR_VALUE
{
    ...
    {
        Format = format;
        /* Utiliser memcpy pour conserver les valeurs NAN */
...
//------------------------------------------------------------------------------------------------
// Retourne la taille nécessaire de la mémoire tampon à utiliser pour le chargement des données
...
//------------------------------------------------------------------------------------------------
// Tous les tableaux doivent être remplis (par exemple, en appelant GetCopyableFootprints)
...
//------------------------------------------------------------------------------------------------
// Implémentation de UpdateSubresources par allocation de tas
inline UINT64 UpdateSubresources(
    _In_ ID3D12GraphicsCommandList* pCmdList,
    _In_ ID3D12Resource* pDestinationResource,
    _In_ ID3D12Resource* pIntermediate,
...
//------------------------------------------------------------------------------------------------
// Implémentation de UpdateSubresources par allocation de piles
...
{
    // Ce cast permet de passer des pointeurs de liste de commandes fortement typés dans
    // ExecuteCommandLists.
    // Ce cast est valide tant que la const-ness est respectée. Les API D3D12
    // respectent la const-ness de leurs arguments.
